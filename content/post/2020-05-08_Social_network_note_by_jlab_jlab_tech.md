...
+ 社会关系网络对职场生涯、个人生活的影响比个体素质影响更高
+ Burt认为，跨越多个（异质）网络、组织之间的洞的人，称为桥梁的人，会更有优势
+ 包括：信息跨越优势、多元化信息来源优势、信息优势转化为控制权
+ 例如部门中跨部门沟通的角色、跨越地域角色、国会的游说代理

## 4 多重网络

+ 深圳的转化：从渔村到国际大都市
+ 交通要道是城市崛起的原因之一（水路、铁路、空运等）
+ 实体货物的运输会有不同节点，信息网络（科技、金融、管理等）也是流通的核心之一
+ 1.网络随着时间会有价值衰退，有生命周期
+ 2.新网络不断产生、兴起，取代旧网络
+ 3.后来者在既有网络超越概率很低，只有创新建立网络，才能更快超越
+ 4.跨越网络的过程：从熟人社会到了全球金融网络的切换升级
+ 5.本质上是阶级分层下的不同立体网络的生命周期，也是个体发生阶级升级、跃迁和降级的过程

## 5 同质/异质网络
+ 选择效应：选择相似的网络关系--同质性关系，愉快融洽互动信任感，更容易共鸣，能低成本快速建立网络
+ 影响效应：近朱者赤近墨者黑，社会网络总是先互相影响彼此网络距离近的节点
+ 异质性/多样性：更容易成功，更容易创新，更容易建立成功的网络，达成共同目标
+ 例如风投投资趋势，越不发达地区越同质化，越国际化越多样化（异质性）
+ 1.情感取向：同质性网络更稳定，满足更好
+ 2.异质性优势：存在多个行业，在团队内部多样性也带来创新性
## 6 弱关系
+ 弱关系网络：互动频率/信任度/亲密程度/互惠交换/区分强弱关系
+ 60%的好工作通过人际关系：弱关系更有价值
+ 价值信息多数来自于弱关系：不同社会文化会有区别，不同市场化程度不同
+ 国外是弱关系连接，国内是强关系桥（市场化程度低的领域、行业、区域）
+ 强关系传递影响，弱关系传递信息
+ 边燕杰
## 7 小世界--衡量网络大小
+ 节点间的距离：最短路径，1，直接触达；
+ muegram，服从权威实验/陌生人包裹实验（小世界实验），中位数是5.2，1-15之间；六度分割，一个剧作家的标题
+ 距离是6，则是隔了5个人，所以六度分割应该是五度分割
+ 再次实验是全球6.1万人范围内email到指定人，平均距离是六，twitter3亿间平均距离是4.67，facebook20亿平均距离是4.74
+ 互联网所有1万亿页面之间的平均链接距离是19次点击，watts，自然杂志发表计算平均距离的公式：网络指数级增长，而平均距离是线性增长
+ 中心度：三种社会网络，均匀网络--无小世界，中心度线性增长；随机网络--无小世界，中心度距离正态分布；
+ 小世界网络（小圈子）+桥=真实世界
+ kevin beken，贝肯数，美国娱乐圈聚会的游戏，距离老演员贝肯的人脉间隔
+ 因为社交网络和网络集中度原因，世界越变越小，人心理距离越来越远
## 8 幂律分布
+ 节点，连接之后，讨论网络，从整体角度看社会网络
+ 统计学，用来发先规律，归纳推理思维
+ 微博大v、抖音大号和总体比率、汉字常用不常用比率、不同城市人口分布比率、人脉、财富、声望等待
+ 都遵循幂律分布，不同于自然界常见的正态分布，幂律分布的最大最小差距非常大，是1/x的正曲线
+ 美国GDP比上某西非岛国GDP，大约二者之比高达201511.3，中国人口比帕劳群岛人口为64420
+ 人类身高符合正态分布，世界上最高的人与最矮的人（均已去世）的身高分别是2. 72m和0. 57m，二者之比为4.8，这个数值并不是很大
+ 对于人类语言中词汇使用率，物理世界在相当程度上是具有惰性的，动态过程总能找到能量消耗最少的途径，人类的语言经过千万年的演化，最终也具有了这种特性，词频的差异有助于使用较少的词汇表达尽可能多的语义，符合“最小努力原则”.
+ 帕累托研究人类收入统计分布，人收入X 不小于某个特定值x的概率与x的常数次幂亦存在简单的反比关系： P [X ≥x ]～x - k
+ 帕累托法则/28定律/贫富差距，皮凯丽，21世纪新资本论中：资本回报率大于劳动回报率，因此资本越来越多，劳动人民越来越少
+ 以上都是社会现象遵循某一个幂律函数，幂律分布表现为一条斜率为幂指数的负数的直线，这一线性关系是判断给定的实例中随机变量是否满足幂律的依据。
+ 西虹市首富中王多余的故事背后也是因为财富积聚的幂律分布原理
...
+ 社会中幂律分布产生的原因是社会网络互相影响和正反馈的结果，物理学家吧啦巴西认为：和网络生长机制有关：优先连接，连接度越高越优先
+ 是一个系统无序到有序的过程，从随机网络到幂律网络的过程，是少数节点施加影响，能够重新组织整个系统
+ 经济学家弗里德曼：世界是平的
